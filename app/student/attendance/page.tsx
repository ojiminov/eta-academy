  ...
  return (
    <div style={{ padding: "2rem" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ color: "#64748b", margin: 0 }}>Your attendance history across all classes</p>
      </div>

      {total === 0 ? (
        <div className="card" style={{ textAlign: "center", padding: "3rem" }}>
          <div style={{ fontSize: "3rem", marginBottom: "1rem" }}>✅</div>
          <h3 style={{ color: "#1e293b" }}>No attendance records yet</h3>
          <p style={{ color: "#64748b" }}>Your attendance will appear here after classes begin.</p>
        </div>
      ) : (
        <>
          {/* Summary stats */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", marginBottom: "1.5rem" }}>
            {[
              ...
              { label: "Absent", value: absent, color: "#ef4444", bg: "#fee2e2", icon: "❌" },
              { label: "Late", value: late, color: "#f59e0b", bg: "#fef3c7", icon: "⏰" },
              { label: "Excused", value: excused, color: "#64748b", bg: "#f1f5f9", icon: "📋" },
            ].map((s) => (
          ...
          {attendanceRate !== null && (
            <div className="card" style={{ marginBottom: "1.5rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.75rem" }}>
                <span style={{ fontWeight: "600", color: "#1e293b" }}>Attendance Rate</span>
                <span style={{
                  fontSize: "1.5rem",
                  fontWeight: "700",
          ...
          <div className="card" style={{ padding: 0 }}>
            <div style={{ padding: "1.25rem 1.5rem 0.75rem" }}>
              <h2 style={{ fontSize: "1rem", fontWeight: "600", color: "#1e293b", margin: 0 }}>Session History</h2>
            </div>
            <table>
              <thead>
                <tr>
                  ...
                  <tr key={att.id}>
                    <td style={{ fontSize: "0.875rem" }}>
                      <div style={{ fontWeight: "500" }}>
                        {new Date(att.classSession.scheduledAt).toLocaleDateString("en-GB", {
