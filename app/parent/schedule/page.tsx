...
const LEVEL_COLORS: Record<string, string> = { BEGINNER:"#6366f1",ELEMENTARY:"#8b5cf6",PRE_INTERMEDIATE:"#06b6d4",INTERMEDIATE:"#10b981",UPPER_INTERMEDIATE:"#f59e0b",ADVANCED:"#ef4444" };
