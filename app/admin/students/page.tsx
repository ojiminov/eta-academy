  ...
  return (
    <div style={{ padding: "2rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
        <div>
          <h1 style={{ fontSize: "1.5rem", fontWeight: "700", color: "#1e293b", margin: "0 0 0.25rem" }}>Students</h1>
          <p style={{ color: "#64748b", margin: 0 }}>{students.length} students enrolled</p>
        </div>
            ...
            {students.length === 0 ? (
              <tr>
                <td colSpan={6} style={{ textAlign: "center", padding: "3rem", color: "#64748b" }}>
                  No students yet. <Link href="/admin/students/new" style={{ color: "#6366f1" }}>Add the first student</Link>
                </td>
              </tr>
            ) : (
              students.map((s) => (
                <tr key={s.id}>
                  ...
                  <td>
                    <span className="badge badge-blue">{s.englishLevel.replace("_", " ")}</span>
                  </td>
                  <td>
                    {s.groupStudents.length === 0 ? (
                      <span style={{ color: "#94a3b8", fontSize: "0.8rem" }}>No group</span>
                    ) : (
